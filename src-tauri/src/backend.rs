...
const BACKEND_NAME: &str = "triton-mcp-backend.exe";
const BACKEND_PORT: u16 = 11177;
const BACKEND_TAG: &str = "triton-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "PORT";
const ENV_HOST: &str = "HOST";
const ENV_TAURI: &str = "TRITON_MCP_TAURI";
...
pub fn spawn_backend(app: AppHandle, state: &BackendProcess) -> Result<String, String> {
    ...
    log_line(
        &app,
        &format!("spawning {} (cwd {}) on port 11177",
    ...
    Ok(format!("Backend starting on port 11177"))
}
